...
class CdkInfraStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        eks_instance_profile = iam.CfnInstanceProfile(self, 'eksInstanceProfile',
                                                      roles=[eks_role.role_name],
                                                      instance_profile_name='eks-cluster-role')

        # EKS cluster provision and attach role as master_role
        cluster = eks.Cluster(self, 'test-net', cluster_name='eks-cluster-cryptoTestNet',
        ...
        eks_nodegroup = cluster.add_nodegroup_capacity('eks-nodegroup',
